...
\draw [->, colorTransition] (q12) edge [, bend right=0,above, align=center, ] node []{\textcolor{colorSync}{$?leaf9\_ok$}} (q13);
\draw [->, colorTransition] (q12) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v1 : = v1+3}$}}\\\textcolor{colorSync}{$?leaf9\_nok$}} (q16);
\draw [->, colorTransition] (q12) edge [, bend right=55,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v1 : = v1+3}$}}\\\textcolor{colorSync}{$?leaf8\_nok$}} (q16);
\draw [->, colorTransition] (q12) edge [, bend right=110,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v1 : = v1+3}$}}\\\textcolor{colorSync}{$?AND3\_nok$}} (q16);
\draw [->, colorTransition] (q13) edge [, bend right=0,above, align=center, ] node []{\textcolor{colorSync}{$?leaf8\_ok$}} (q14);
\draw [->, colorTransition] (q14) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v1 : = v1+3}$}}\\\textcolor{colorSync}{$?AND3\_ok$}} (q15);
\draw [->, black] (q15) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{cost\_AND4 : = 0+costC(cost\_leaf9,cost\_leaf8,cost\_AND3)}$}}\\\footnotesize{\textcolor{colorAttribute}{$\mathtt{time\_AND4 : = 1+timeC(time\_leaf9,time\_leaf8,time\_AND3)}$}}\\\textcolor{black}{$AND4$}} (q17);
...
\node[state, right of =q18] (q19) {$l_{leaf9}$};
\node[state, right of =q18, below=3cm] (q20) {$l_{\neg leaf9}$};
\draw [->, black] (q18) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{cost\_leaf9 : = 0}$}}\\\footnotesize{\textcolor{colorAttribute}{$\mathtt{time\_leaf9 : = 1}$}}\\\textcolor{black}{$leaf9$}} (q19);
\draw [->, colorTransition] (q18) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!leaf9\_nok$}} (q20);
\draw [->, colorTransition] (q19) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!leaf9\_ok$}} (q19);
\draw [->, colorTransition] (q20) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!leaf9\_nok$}} (q20);
\end{tikzpicture}
}
...
\node[state, right of =q21] (q22) {$l_{leaf8}$};
\node[state, right of =q21, below=3cm] (q23) {$l_{\neg leaf8}$};
\draw [->, black] (q21) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{cost\_leaf8 : = 0}$}}\\\footnotesize{\textcolor{colorAttribute}{$\mathtt{time\_leaf8 : = 1}$}}\\\textcolor{black}{$leaf8$}} (q22);
\draw [->, colorTransition] (q21) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!leaf8\_nok$}} (q23);
\draw [->, colorTransition] (q22) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!leaf8\_ok$}} (q22);
\draw [->, colorTransition] (q23) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!leaf8\_nok$}} (q23);
\end{tikzpicture}
}
...
\node[state, right of =q26] (q27) {$l_{3}$};
\node[state, right of =q27] (q29) {$l_{AND3}$};
\node[state, right of =q24, below=3cm] (q28) {$l_{\neg AND3}$};
\draw [->, colorTransition] (q24) edge [, bend right=0,above, align=center, ] node []{\textcolor{colorSync}{$?leaf7\_ok$}} (q25);
\draw [->, colorTransition] (q24) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v2 : = v2+3}$}}\\\textcolor{colorSync}{$?leaf7\_nok$}} (q28);
\draw [->, colorTransition] (q24) edge [, bend right=55,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v2 : = v2+3}$}}\\\textcolor{colorSync}{$?AND2\_nok$}} (q28);
\draw [->, colorTransition] (q24) edge [, bend right=110,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v2 : = v2+3}$}}\\\textcolor{colorSync}{$?AND1\_nok$}} (q28);
\draw [->, colorTransition] (q25) edge [, bend right=0,above, align=center, ] node []{\textcolor{colorSync}{$?AND2\_ok$}} (q26);
\draw [->, colorTransition] (q26) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v2 : = v2+3}$}}\\\textcolor{colorSync}{$?AND1\_ok$}} (q27);
\draw [->, black] (q27) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{cost\_AND3 : = 0+costC(cost\_leaf7,cost\_AND2,cost\_AND1)}$}}\\\footnotesize{\textcolor{colorAttribute}{$\mathtt{time\_AND3 : = 1+timeC(time\_leaf7,time\_AND2,time\_AND1)}$}}\\\textcolor{black}{$AND3$}} (q29);
\draw [->, colorTransition] (q29) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!AND3\_ok$}} (q29);
\draw [->, colorTransition] (q28) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v2=3}$}}\\\textcolor{colorSync}{$!AND3\_nok$}} (q28);
\end{tikzpicture}
}
...
\draw [->, colorTransition] (q30) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!leaf7\_nok$}} (q32);
\draw [->, colorTransition] (q31) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!leaf7\_ok$}} (q31);
\draw [->, colorTransition] (q32) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!leaf7\_nok$}} (q32);
\end{tikzpicture}
}
...
\draw [->, colorTransition] (q33) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf6\_nok$}} (q37);
\draw [->, colorTransition] (q33) edge [, bend right=55,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf5\_nok$}} (q37);
\draw [->, colorTransition] (q33) edge [, bend right=110,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf4\_nok$}} (q37);
\draw [->, colorTransition] (q34) edge [, bend right=0,above, align=center, ] node []{\textcolor{colorSync}{$?leaf5\_ok$}} (q35);
\draw [->, colorTransition] (q35) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf4\_ok$}} (q36);
...
\draw [->, colorTransition] (q38) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!AND2\_ok$}} (q38);
\draw [->, colorTransition] (q37) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!AND2\_nok$}} (q37);
\end{tikzpicture}
}
...
\draw [->, colorTransition] (q48) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf3\_nok$}} (q52);
\draw [->, colorTransition] (q48) edge [, bend right=55,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf2\_nok$}} (q52);
\draw [->, colorTransition] (q48) edge [, bend right=110,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf1\_nok$}} (q52);
\draw [->, colorTransition] (q49) edge [, bend right=0,above, align=center, ] node []{\textcolor{colorSync}{$?leaf2\_ok$}} (q50);
\draw [->, colorTransition] (q50) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{v3 : = v3+3}$}}\\\textcolor{colorSync}{$?leaf1\_ok$}} (q51);
...
\draw [->, colorTransition] (q53) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!AND1\_ok$}} (q53);
\draw [->, colorTransition] (q52) edge [loop right, above, align=center, ] node [rotate=90, anchor=west]{\footnotesize{\textcolor{colorCondition}{$\mathtt{v3=6}$}}\\\textcolor{colorSync}{$!AND1\_nok$}} (q52);
\end{tikzpicture}
}
...
\draw [->, black] (q60) edge [, bend right=0,above, align=center, ] node []{\footnotesize{\textcolor{colorAttribute}{$\mathtt{cost\_leaf1 : = 0}$}}\\\footnotesize{\textcolor{colorAttribute}{$\mathtt{time\_leaf1 : = 3}$}}\\\textcolor{black}{$leaf1$}} (q61);
